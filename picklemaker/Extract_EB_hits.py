...
#def cartfeat(x,y,z,E,noise,flag=None) :
#    if flag is not None:
#        return ak.concatenate((x[:, :, None], y[:, :, None], z[:, :, None], E[:, :, None],noise[:,:,None],flag[:,:,None]),-1,)
#    else :
#        return ak.concatenate((x[:, :, None], y[:, :, None], z[:, :, None], E[:, :, None],noise[:,:,None]),-1,)
#def cartfeat(x,y,z,E,noise) :
	#return ak.concatenate((x[:, :, None], y[:, :, None], z[:, :, None], E[:, :, None],noise[:,:,None]),-1,)
...
class Extract:
    ...
    def read(self, N=None):
        ...
        for start in range(0,len(target),chunksize):
            ...
            HitsX = ak.concatenate((arrs["Hit_X_Pho1"][start:stop], arrs["Hit_X_Pho2"][start:stop]), axis=1)
            HitsY = ak.concatenate((arrs["Hit_Y_Pho1"][start:stop], arrs["Hit_Y_Pho2"][start:stop]), axis=1)
            HitsZ = ak.concatenate((arrs["Hit_Z_Pho1"][start:stop], arrs["Hit_Z_Pho2"][start:stop]), axis=1)
            HitsEn = ak.concatenate((arrs["RecHitEnPho1"][start:stop], arrs["RecHitEnPho2"][start:stop]), axis=1)
            #HitsEta = ak.concatenate((arrs["Hit_Eta_Pho1"][start:stop], arrs["Hit_Eta_Pho2"][start:stop]), axis=1)
            #HitsPhi = ak.concatenate((arrs["Hit_Phi_Pho1"][start:stop], arrs["Hit_Phi_Pho2"][start:stop]), axis=1)
            #HitsiEta = ak.concatenate((arrs["iEtaPho1"][start:stop], arrs["iEtaPho2"][start:stop]), axis=1)
            #HitsiPhi = ak.concatenate((arrs["iPhiPho1"][start:stop], arrs["iPhiPho2"][start:stop]), axis=1)
            ...
            #HitsESEta = ak.concatenate((arrs["Hit_ES_Eta_Pho1"][start:stop], arrs["Hit_ES_Eta_Pho2"][start:stop]), axis=1)
            #HitsESPhi = ak.concatenate((arrs["Hit_ES_Phi_Pho1"][start:stop], arrs["Hit_ES_Phi_Pho2"][start:stop]), axis=1)
            HitsEE_En = HitsEn

            #Hitnoise = ak.concatenate((arrs["HitNoisePho1"][start:stop],arrs["HitNoisePho2"][start:stop]),axis=1)
            ...
            #Hitnoise=ak.concatenate((Hitnoise,HitESnoise),axis=-1)
            '''

            #cf=cartfeat(HitsX,HitsY,HitsZ,HitsEn,flg)
            cf=cartfeat(HitsX,HitsY,HitsZ,HitsEn)
            #cf=cartfeat(HitsX,HitsY,HitsZ,HitsEn,Hitnoise)
            t0=time()
